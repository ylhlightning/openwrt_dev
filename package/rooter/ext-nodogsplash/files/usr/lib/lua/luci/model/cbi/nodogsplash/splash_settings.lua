...
local db = require "luci.nodogsplash.debugger"
local uci = require "luci.model.uci".cursor()
local fs = require "nixio.fs"
local ccbi = require "luci.nodogsplash.ccbi"
local lfs = require "luci.fs"
local dt = require "luci.cbi.datatypes"
local cvd = require "luci.nodogsplash.validate"
local uri = require "uri"

m = Map("nodogsplash", translate("Nodogsplash Captive Portal"))

enable = m:section(TypedSection, "settings", translate("On/Off"), translate("Users can be redirected to a â€œwelcome pageâ€ when they first connect to this node."))
...
inter = m:section(TypedSection, "interfaces", translate("Gateway Name"), translate("The name placed in $gateway for use on Welcome page"))
inter.anonymous = true

iname = inter:option(Value, "name")
iname.optional = false
iname.rmempty = false
iname.default="ROOter Captive Portal"
...
local splashtextfile = "/usr/lib/lua/luci/view/nodogsplash/splashtext.htm"
